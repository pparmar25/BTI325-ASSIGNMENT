...
* 
*  Name: Parmar pranjal   Student ID: 117504225   Date: Dec 4, 2023
*
*  Online (Cyclic) URL: 
*
********************************************************************************/ 
...
cloudinary.config({
  cloud_name: 'dfikhr9g7',
  api_key: '927781789454638',
  api_secret: 'neubVUlcHhBV5gqoPjp72iMdQas',
  secure: true
});
const upload = multer(); 
...
app.use((req, res) => {
  res.status(404).send("Your code is not working");
});
